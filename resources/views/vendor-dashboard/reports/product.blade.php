...
@section('header__title', __('home.best_sales'))
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    {{-- <td>{{ $order->total_quantity * $order->price }}</td> --}}
        ...
        $(document).ready(function() {
            ...
            $.fn.dataTable.ext.search.push(
                function(settings, data, dataIndex) {
                    ...
                    var dateColumn = data[0]; // Assuming the date column is the 2nd column (index 1)
