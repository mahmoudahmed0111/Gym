    ...
    <div class="p-3 container-p-y">
        <div class="card">
            <div class="d-flex align-item-center p-4 justify-content-between w-100">
                <h5 class="card-header p-0">{{ __('home.products') }}</h5>
                                ...
                                <td class="">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('vendor.products.edit', $product->id) }}"><i
                                    ...
                                    @include('components.modalDelete', [
                                        'action' => 'vendor.products.destroy',
                                        'name' => $product->name,
    ...
    $(document).ready(function() {
        ...
        $('#deleteSelected').click(function() {
            ...
            if (selectedIds.length > 0) {
                $.ajax({
                    url: "{{ route('vendor.products.deleteSelected') }}",
                    type: "POST",
