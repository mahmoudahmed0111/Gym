                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="d-flex p-3 px-4 align-items-center justify-content-between w-100">
                            <h5 class="card-header p-0">{{ __('home.Add') }} {{ __('home.products') }}</h5>
                        ...
                        <div class="card-body">
                            <form action="{{ route('vendor.products.store') }}" method="POST" class="row product-store"
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <!--end::Description-->
                                    @if (isset($item))
                                        <input type="hidden" id="images_product"
                                            value="{{ json_encode($item->images) }}">
                                    @endif
                                </div>
                                <br>
