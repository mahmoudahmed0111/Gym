...
@section('header__title', __('home.products'))
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="d-flex p-3 px-4 align-items-center justify-content-between w-100">
                            <h5 class="card-header p-0">{{ __('home.Edit') }} {{ __('home.products') }}</h5>
                            <a href="{{ route('vendor.products.index') }}" style="width: fit-content">
                        ...
                        <div class="card-body">
                            <form action="{{ route('vendor.products.update', $data->id) }}" method="POST"
                                class="row product-store" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="col-md-6">
...
@section('scripts-dashboard')
    ...
    $('#add-attribute').on('click', function() {
        ...
        $newAttribute.find(`input[name="attributes[${attributeIndex}][type]"]`).on('change', function() {
