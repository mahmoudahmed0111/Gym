        ...
        <div class="p-3 container-p-y">
            <div class="card">
                <div class="d-flex align-item-center p-4 justify-content-between w-100">
                    ...
                    <a href="{{ route('trainee.trainings.index') }}" style="width: fit-content">
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <img src="{{ image_url($training->image) }}" alt class="w-px-50 h-auto rounded" />
                                            {{ $training->name }}
                                        </div>
                                    </th>
                                    <td>{{ $training->desc }}</td>
        ...
        $(document).ready(function() {
            ...
            $.fn.dataTable.ext.search.push(
                function(settings, data, dataIndex) {
                    ...
                    var dateColumn = data[2]; // Assuming the date column is the 3rd column (index 2)
