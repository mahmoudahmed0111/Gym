        ...
        <div class="p-3 container-p-y">
            <div class="card">
                <div class="d-flex align-item-center p-4 justify-content-between w-100">
                    ...
                    <h5 class="card-header p-0">{{ __('home.gallery') }}</h5>
                    <div class="d-flex align-item-center gap-3">
                        <button type="button" class="btn btn-danger">
                            <i class="fa-regular fa-trash-can"></i>
                            {{ __('home.Delete') }}
                        </button>
                        <a href="{{ route('trainee.progress.create') }}">
                ...
                <div class="table-responsive text-nowrap px-4">
                    <table class="table" id="myTable">
                        ...
                        <tbody>
                            @foreach ($progress as $trainee)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ $trainee ? image_url($trainee->img) : asset('assett/img/hero/hero-2.jpg') }}" class="w-px-50 h-auto rounded" />
                                        </div>
                                    </td>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('trainee.progress.edit', $trainee->id) }}"><i
                                        ...
                                        @include('components.modalDelete', [
                                            'action' => 'trainee.progress.destroy',
                                            'name' => $trainee->name,
