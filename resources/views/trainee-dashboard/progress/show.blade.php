        ...
        <div class="p-3 container-p-y">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        <h5 class="card-header"> landing-slider Details</h5>
                        <!-- Account -->
                        <!-- Account -->
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            <form id="formAccountSettings" method="POST" onsubmit="return false">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="phone" class="form-label">{{ __('home.landing-slider') }} </label>
