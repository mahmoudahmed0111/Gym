        ...
        <div class="p-3 container-p-y">
            <div class="card">
                <div class="d-flex align-item-center p-4 justify-content-between w-100">
                    ...
                    <h5 class="card-header p-0">{{ __('home.host_tournament') }}</h5>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('championship.edit', $admin->id) }}"><i
                                                ...
                                                <a class="dropdown-item cursor-pointer" data-bs-toggle="modal"
                                                    ...
                                                    {{ __('home.Delete') }}</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('championship.show', $admin->id) }}"><i
                                                        class="bx bx-show me-1"></i> {{ __('home.Show') }}</a>
                                            </div>
                                        </div>
                                        @include('components.modalDelete', [
                                            'action' => 'championship.destroy',
                                            'name' => $admin->name,
