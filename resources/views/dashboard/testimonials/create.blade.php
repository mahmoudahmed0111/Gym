...
@section('header__title',   __('home.testimonials'))
                ...
                <div class="col-md-12">
                    <div class="card mb-4 ">
                        <div class="d-flex p-3 px-4 align-items-center justify-content-between w-100">
                            <h5 class="card-header p-0">{{ __('home.Add') }} {{ __('home.testimonial') }}</h5>
                            <a href="{{ route('testimonials.index') }}" style="width: fit-content">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('testimonials.store') }}" method="POST" class="row" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    @include('components.input', [
                                        ...
                                        'type' => 'text',
                                        'label' => 'testimonials',
                                        'placeholder' => __('home.testimonials'),
                                    ])
