        ...
        <div class="p-3 container-p-y">
            <div class="card">
                <div class="d-flex align-item-center p-4 justify-content-between w-100">
                    ...
                    <h5 class="card-header p-0">{{ __('home.landing-slider') }}</h5>
                    <div class="d-flex align-item-center gap-3">
                        <button type="button" class="btn btn-danger">
                            <i class="fa-regular fa-trash-can"></i>
                            {{ __('home.Delete') }}
                        </button>
                        <a href="{{ route('landing-slider.create') }}">
                                ...
                                <th>
                                    <div class="d-flex align-items-center gap-2">
                                        <input class="form-check-input row__check" type="checkbox" value=""
                                            id="check__box" />
                                        {{ __('home.first sentence') }}
                                    </div>
                                </th>
                                <th>{{ __('home.second sentence') }}</th>
                                <th>{{ __('home.img') }}</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $admin)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img class="w-px-50 h-auto rounded" src={{ image_url( $admin->img) }} alt
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('landing-slider.edit', $admin->id) }}"><i
                                                ...
                                                <a class="dropdown-item cursor-pointer" data-bs-toggle="modal"
                                                    ...
                                                    {{ __('home.Delete') }}</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('landing-slider.show', $admin->id) }}"><i
                                                        class="bx bx-show me-1"></i> {{ __('home.Show') }}</a>
                                            </div>
                                        </div>
                                        @include('components.modalDelete', [
                                            'action' => 'landing-slider.destroy',
                                            'name' => $admin->name,
