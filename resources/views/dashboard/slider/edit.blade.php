                ...
                <div class="col-md-12">
                    <div class="card mb-4 ">
                        <div class="d-flex p-3 px-4 align-items-center justify-content-between w-100">
                            <h5 class="card-header p-0">{{ __('home.Add') }} {{ __('home.sliders') }}</h5>
                            <a href="{{ route('sliders.index') }}" style="width: fit-content">
                        ...
                        <div class="card-body">
                            <form action="{{ route('sliders.update',$data->id) }}" method="POST" class="row" enctype="multipart/form-data">
                                @method("put")
                                @csrf
