...
@section('header__title',   __('home.team'))
                ...
                <div class="col-md-12">
                    <div class="card mb-4 ">
                        <div class="d-flex p-3 px-4 align-items-center justify-content-between w-100">
                            <h5 class="card-header p-0">{{ __('home.Add') }} {{ __('home.member') }}</h5>
                            <a href="{{ route('team.index') }}" style="width: fit-content">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('team.store') }}" method="POST" class="row" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-6">
