                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                <img src="{{ image_url( $data->img) }}" alt="vendors-avatar" class="d-block rounded"
