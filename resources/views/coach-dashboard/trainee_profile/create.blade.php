            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4 ">
                        ...
                        <div class="card-body">
                            <form action="{{ route('coach.trainees-profile.store') }}" method="POST" class="row" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    @include('components.input', [
                                        'value' => old('body_water_percentage'),
                                ...
                                <div class="col-md-6">
                                    @include('components.input', [
                                        ...
                                        'placeholder' => 'اكتب لنا اذا كنت تعاني من مشكله',
                                    ])
                                </div>
