        ...
        <div class="p-3 container-p-y">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        <h5 class="card-header">trainings for Category: {{ $data->name }}</h5>
                        <!-- Account -->
                        <!-- Account -->
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <div class="button-wrapper w-100">
                                    ...
                                    <div class="mb-3 w-100  col-md-6">
                                        ...
                                        <span
                                            class="w-100 bg-label-{{ $data->is_active ? 'primary' : 'danger' }}  p-1 rounded">
                        ...
                        <div class="table-responsive text-nowrap px-4">
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('coach.categories.edit', $training->id) }}">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6">No trainings found for this category.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
