        ...
        <div class="p-3 container-p-y">
            <div class="card">
                <div class="d-flex align-item-center p-4 justify-content-between w-100">
                    ...
                    <h5 class="card-header p-0">{{ __('home.links') }}</h5>
                    <div class="d-flex align-item-center gap-3">
                        <button type="button" class="btn btn-danger">
                            <i class="fa-regular fa-trash-can"></i>
                            {{ __('home.Delete') }}
                        </button>
                        <a href="{{ route('club.links.create') }}">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('club.links.edit', $link->id) }}"><i
                                                        class="bx bx-edit-alt me-1"></i> {{ __('home.Edit') }}</a>
                                                <a class="dropdown-item cursor-pointer" data-bs-toggle="modal"
                                                    data-bs-target="#modalToggle{{$link->id}}"><i class="bx bx-trash me-1"></i>
                                                    {{ __('home.Delete') }}</a>

                                            </div>
                                        </div>
                                        @include('components.modalDelete', [
                                            'action' => 'club.links.destroy',
                                            'name' => $link->name,
                                            'title' => __('home.Are You Delete'),
                                            'modalToggle' => 'modalToggle'.$link->id,
                                            'id' => $link->id,
                                        ])
                                    </td>
                                </tr>
