...
@section('header__title', __('home.classes'))
                ...
                <div class="col-md-12">
                    <div class="card mb-4 ">
                        <div class="d-flex p-3 px-4 align-items-center justify-content-between w-100">
                            <h5 class="card-header p-0">{{ __('home.Add') }} {{ __('home.classes') }}</h5>
                            <a href="{{ route('club.links.index') }}" style="width: fit-content">
                        ...
                        <div class="card-body">
                            <form action="{{ route('club.links.update',$link->id) }}" method="POST" class="row" enctype="multipart/form-data">
                                @method("put")
                                @csrf
                                <div class="col-md-6">
