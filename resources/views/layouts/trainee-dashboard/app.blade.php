...
@include('layouts.trainee-dashboard.head')
...
<body id="kt_body" data-theme="light" data-kt-name="metronic" class="header-tablet-and-mobile-fixed aside-enabled">
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            @include('layouts.trainee-dashboard.sidebar')
            <!-- / Menu -->
            <div class="layout-page">
                @include('layouts.trainee-dashboard.header')
    ...
    @include('layouts.trainee-dashboard.scripts')
