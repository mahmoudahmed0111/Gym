        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 p-0">
                    <div class="blog-item">
                        <div class="bi-pic">
                            <img src="{{ asset('assett/img/blog/blog-1.jpg') }}" alt="">
                        </div>
                        <div class="bi-text">
                    ...
                    <div class="blog-item">
                        <div class="bi-pic">
                            <img src="{{ asset('assett/img/blog/blog-2.jpg') }}" alt="">
                        </div>
                        <div class="bi-text">
                            <h5><a href="./blog-details.html">Vegan White Peach Mug Cobbler With Cardam Vegan White Peach Mug
                                    Cobbler...</a></h5>
                    ...
                    <div class="blog-item">
                        <div class="bi-pic">
                            <img src="{{ asset('assett/img/blog/blog-3.jpg') }}" alt="">
                        </div>
                        <div class="bi-text">
                            <h5><a href="./blog-details.html">Vegan White Peach Mug Cobbler With Cardam Vegan White Peach Mug
                                    Cobbler...</a></h5>
                    ...
                    <div class="blog-item">
                        <div class="bi-pic">
                            <img src="{{ asset('assett/img/blog/blog-4.jpg') }}" alt="">
                        </div>
                        <div class="bi-text">
                            <h5><a href="./blog-details.html">Vegan White Peach Mug Cobbler With Cardam Vegan White Peach Mug
                                    Cobbler...</a></h5>
                    ...
                    <div class="blog-item">
                        <div class="bi-pic">
                            <img src="{{ asset('assett/img/blog/blog-5.jpg') }}" alt="">
                        </div>
                        <div class="bi-text">
                            <h5><a href="./blog-details.html">Vegan White Peach Mug Cobbler With Cardam Vegan White Peach Mug
                                    Cobbler...</a></h5>
                ...
                <div class="col-lg-4 col-md-8 p-0">
                    <div class="sidebar-option">
                        ...
                        <div class="so-latest">
                            ...
                            <div class="latest-large set-bg" data-setbg="{{ asset('assett/img/letest-blog/latest-1.jpg') }}">
                                <div class="ll-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="{{ asset('assett/img/letest-blog/latest-2.jpg') }}" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="{{ asset('assett/img/letest-blog/latest-3.jpg') }}" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="{{ asset('assett/img/letest-blog/latest-4.jpg') }}" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="{{ asset('assett/img/letest-blog/latest-5.jpg') }}" alt="">
                                </div>
                                <div class="li-text">
