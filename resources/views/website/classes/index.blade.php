            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="class-details-text">
                        <div class="cd-pic">
                            <img src="{{ asset('assett/img/classes/class-details/class-detailsl.jpg') }}" alt="">
                        </div>
                        <div class="cd-text">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cd-trainer-pic">
                                        <img src="{{ asset('assett/img/classes/class-details/trainer-profile.jpg') }}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="sidebar-option">
                        ...
                        <div class="so-banner set-bg" data-setbg="{{ asset('assett/img/sidebar-banner.jpg') }}">
