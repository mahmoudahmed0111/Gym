...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("vendor-dashboard.products.index", compact("data"));
    }
    ...
    public function create()
    {
        ...
        return view("vendor-dashboard.products.create",compact('categories'));
    ...
    public function show($id)
    {
        ...
        return view("vendor-dashboard.products.show", compact("data"));
    }
    ...
    public function edit($id)
    {
        $categories = CategoryProduct::all();
        $data = Product::find($id);
        return view("vendor-dashboard.products.edit", compact("data",'categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('vendor.products.index'))->with('success', __('models.edited_successfully'));
    }
    ...
    public function destroy($id)
    {
        ...
        $model->delete();
        return redirect(route('vendor.products.index'))->with('success', __('models.deleted_successfully'));
